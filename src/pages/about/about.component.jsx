            ...
            <Col xs={12} md={6}>
              <Row className=" align-items-start p-2 my-details rounded">
                ...
                <Col className="d-flex justify-content-center flex-wrap">
                  ...
                  <div>
                    <a
                      href="https://drive.google.com/file/d/14C3q90GNECkJhtg5o575a3lqDpRoYkDX/view?usp=sharing"
                      target="_blank"
