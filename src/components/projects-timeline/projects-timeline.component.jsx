          ...
          >
            <div className="d-flex justify-content-between flex-column mt-1">
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton
                  href="https://abunomanroni-assignment-7.netlify.app/"
                  target="_blank"
                >
                  SEE LIVE
                </UrlButton>
                <UrlButton
                  href="https://github.com/ronibd?tab=repositories"
                  target="_blank"
                >
                  SOURCE CODE
                </UrlButton>
                <UrlButton
                  href="https://www.linkedin.com/in/abunomanroni-bd/"
                  target="_blank"
                >
                  WATCH VIDEO
                </UrlButton>
...
<ImageEvent
          ...
          >
            <div className="d-flex justify-content-between flex-column mt-1">
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton
                  href="https://abunomanroni-assignment-9.netlify.app/"
                  target="_blank"
                >
                  SOURCE CODE
                </UrlButton>
          ...
          >
            <div className="d-flex justify-content-between flex-column mt-1">
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton
                  href="https://abunomanroni-assingment-8.netlify.app/"
                  target="_blank"
                >
                  SEE LIVE
                </UrlButton>
                <UrlButton
                  href="https://github.com/ronibd/friends-zone-with-situation"
                  target="_blank"
                >
                  SOURCE CODE
                </UrlButton>
          ...
          >
            <div className="d-flex justify-content-between flex-column mt-1">
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton
                  href="https://github.com/ronibd/course-review-cosmicray"
                  target="_blank"
                >
                  SOURCE CODE
                </UrlButton>
